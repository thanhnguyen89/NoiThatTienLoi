...
const target = fs.readFileSync('src/admin/features/product/ProductForm.tsx', 'utf8');
...
// Write result
fs.writeFileSync('src/admin/features/product/ProductForm.tsx', result, 'utf8');

console.log('✅ Done! All 3 tabs replaced in ProductForm.');
