...
export function AdminUserFilters({ defaultSearch, defaultStatus }: Props) {
    ...
    <>
      <div className="row g-2 align-items-end">
        ...
        <div className="col-md-3 d-flex gap-2 justify-content-end">
          <button type="button" className="btn btn-sm btn-search" onClick={() => push({ search: search.trim() || undefined, status: status || undefined })}>
            <i className="bi bi-search me-1"></i>Tìm kiếm
          </button>
          <button type="button" className="btn btn-sm btn-reset" onClick={() => { setSearch(''); setStatus(''); push({ search: undefined, status: undefined }); }}>
