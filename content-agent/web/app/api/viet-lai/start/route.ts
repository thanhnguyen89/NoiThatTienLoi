...
import { countHtmlWords, extractArticleTitle, extractSectionsByHeading } from '@/lib/viet-lai/html-parser';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { config, draftArticleId } = parsed.data as { config: ArticleRewriteConfig; draftArticleId?: string };
